window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const DICTS = {
			zh: {
				...
				resetModeSoft: "软",
				resetModeHard: "强制",
				confirmReset: "确定要将当前分支重置到 {hash} ({mode})?",
				resetHintMixed: "混合:移动指针并重置暂存区,保留工作区改动",
				resetHintSoft: "软:仅移动指针,保留暂存区",
				resetHintHard: "强制:丢弃所有未提交更改",
				resetDone: "已重置到 {hash} ({mode})",
				revertTitle: "回退提交",
				confirmRevert: "将创建一个新的反向提交来撤销 {hash} 的更改。确定继续吗?",
				revertDone: "已回退 {hash}",
			...
			en: {
				...
				confirmMerge: "Merge branch {name} into the current branch?",
				mergeDone: "Merged {name}",
				...
				resetCommit: "Reset to this commit",
				...
				resetTitle: "Reset Commit",
				resetModeLabel: "Reset mode:",
				resetModeMixed: "Mixed",
				resetModeSoft: "Soft",
				resetModeHard: "Hard",
				confirmReset: "Reset the current branch to {hash} ({mode})?",
				resetHintMixed: "Mixed: move the pointer and reset the index, keep worktree changes",
				resetHintSoft: "Soft: move the pointer only, keep the index",
				resetHintHard: "Hard: discard all uncommitted changes",
				resetDone: "Reset to {hash} ({mode})",
				revertTitle: "Revert Commit",
				confirmRevert: "Create a new commit that undoes the changes of {hash}?",
				revertDone: "Reverted {hash}",
		...
		*/
		...
		var WbRequestError = class extends Error {
			code;
		...
		async function postWb(path, body) {
			...
			if (json.ok !== true || json.value === void 0) throw new WbRequestError(json.error?.code ?? "unknown", json.error?.message ?? `${path} failed`);
			return json.value;
		}
		...
		*  for additions/deletions. */
		...
		function CommitView(props) {
			...
			const boundSessionId = typeof seedMeta?.sessionId === "string" ? seedMeta.sessionId : void 0;
			const rawRepoRoot = typeof seedMeta?.repoRoot === "string" && seedMeta.repoRoot !== "" ? seedMeta.repoRoot : void 0;
			const repoRoot = rawRepoRoot !== void 0 && boundSessionId !== sessionId ? void 0 : rawRepoRoot;
			...
			const [panelIsWorktree, setPanelIsWorktree] = (0, react.useState)(false);
			const [wtSelectedFile, setWtSelectedFile] = (0, react.useState)(null);
			const [wtOld, setWtOld] = (0, react.useState)(null);
			const [wtNew, setWtNew] = (0, react.useState)(null);
			const [wtLoading, setWtLoading] = (0, react.useState)(false);
			...
			const [remotes, setRemotes] = (0, react.useState)([]);
			const [resetMode, setResetMode] = (0, react.useState)("mixed");
			...
			(0, react.useEffect)(() => {
				...
				postWb("/wb-git/log", body({
					...
					if (cancelled || seq !== logSeq.current) return;
					setLoading(false);
					const message = cause instanceof WbRequestError && cause.code === "workspace-not-ready" ? "workspace is not ready; retry after it finishes loading" : messageOf(cause);
			...
			(0, react.useEffect)(() => {
				...
				setWtSelectedFile((current) => current !== null && statusFiles.some((f) => f.path === current) ? current : statusFiles[0]?.path ?? null);
			}, [panelIsWorktree, statusFiles]);
			(0, react.useEffect)(() => {
				if (!panelIsWorktree || wtSelectedFile === null || sessionId === void 0) {
					setWtOld(null);
					setWtNew(null);
					setWtLoading(false);
					return;
				...
				let cancelled = false;
				setWtLoading(true);
				postWb("/wb-git/worktree-content", body({ path: wtSelectedFile })).then((value) => {
			...
			*  detail panel and the working-tree panel. Both panes scroll in sync. */
			const buildDiffPane = (0, react.useCallback)((selectedPath, oldContent, newContent, loading) => {
				const empty = (key) => (0, react.createElement)("div", { className: "dg-content-empty" }, t(key));
			...
			*  selected. */
			const buildWorktreeForm = (0, react.useCallback)(() => {
				...
				return (0, react.createElement)("div", { className: "dg-commit-form" }, (0, react.createElement)("div", { className: "dg-commit-form-title" }, t("filesLabel")), statusFiles.length === 0 ? (0, react.createElement)("div", { className: "dg-commit-empty dg-commit-form-empty" }, t("noChanges")) : (0, react.createElement)("div", { className: "dg-commit-form-files" }, ...fileRows), (0, react.createElement)("div", { className: "dg-commit-form-footer" }, (0, react.createElement)("div", { className: "dg-commit-actions" }, (0, react.createElement)("button", {
					className: "dg-btn",
			...
			if (panelOpen && (panelIsWorktree || panelHash !== null)) {
				const commit = panelIsWorktree ? void 0 : commits.find((c) => c.hash === panelHash);
				const panelTitle = panelIsWorktree ? t("uncommittedChanges") : commit !== void 0 ? commit.message : panelHash !== null ? shortHash(panelHash) : "";
				...
				let bodyNode;
				if (panelIsWorktree) bodyNode = (0, react.createElement)("div", { className: "dg-detail-panel-body" }, (0, react.createElement)("div", { className: "dg-detail-cols" }, buildWorktreeForm(), buildDiffPane(wtSelectedFile, wtOld, wtNew, wtLoading)));
					...
					bodyNode = (0, react.createElement)("div", { className: "dg-detail-panel-body" }, (0, react.createElement)("div", { className: "dg-detail-cols" }, (0, react.createElement)("div", { className: "dg-file-tree" }, (0, react.createElement)("div", { className: "dg-file-tree-title" }, t("filesLabel")), ...treeNodes), buildDiffPane(selectedFile, oldContent, newContent, contentLoading)));
				}
				panelNode = (0, react.createElement)("div", {
					...
					title: panelTitle
				}, panelTitle), !panelIsWorktree ? (0, react.createElement)("button", {
					className: "dg-btn",
					title: panelMode === "files" ? t("viewDetails") : t("filesLabel"),
					onClick: () => setPanelMode((m) => m === "files" ? "diff" : "files")
				}, panelMode === "files" ? "⧉" : "≡") : null, (0, react.createElement)("button", {
					className: "dg-btn",
					onClick: () => {
						setPanelOpen(false);
						setPanelHash(null);
					...
					dialogNode = (0, react.createElement)(Dialog, {
						...
						onOk: () => {
							...
							handleRefWrite({
								...
								hash: shortHash(dialog.hash),
								mode: modeLabel
							}));
						},
						onCancel: closeDialog
					}, (0, react.createElement)("div", { key: "reset-confirm" }, t("confirmReset", {
						hash: shortHash(dialog.hash),
						mode: modeLabel
					})), (0, react.createElement)("div", {
						key: "reset-hint",
						className: "dg-muted"
					}, (0, react.createElement)("div", null, t("resetHintMixed")), (0, react.createElement)("div", null, t("resetHintSoft")), (0, react.createElement)("div", null, t("resetHintHard"))), (0, react.createElement)(DialogSelect, {
						key: "reset-mode",
						...
						options: [
							{
								value: "mixed",
								label: t("resetModeMixed")
							},
							{
								value: "soft",
								label: t("resetModeSoft")
							},
							{
								value: "hard",
								label: t("resetModeHard")
							}
						],
					...
					dialogNode = (0, react.createElement)(Dialog, {
						...
						onOk: () => {
							...
							handleRefWrite({
								action: "revert",
								hash: dialog.hash
							}, t("revertDone", { hash: shortHash(dialog.hash) }));
						},
						onCancel: closeDialog
					}, (0, react.createElement)("div", null, t("confirmRevert", { hash: shortHash(dialog.hash) })));
					break;
				case "merge":
					dialogNode = (0, react.createElement)(Dialog, {
						key: "merge",
						...
						onOk: () => {
							...
							handleRefWrite({
								action: "merge",
								name: dialog.name
							}, t("mergeDone", { name: dialog.name }));
						},
						onCancel: closeDialog
					}, (0, react.createElement)("div", null, t("confirmMerge", { name: dialog.name })));
					break;
				case "push": {
			...
			}, ...svgNodes), ...rowNodes), panelNode, opError !== null ? (0, react.createElement)("div", {
		...
		*/
		...
		function GitLauncher(props) {
			...
			*  /wb-git/repos response overwrite a newer one. */
				...
				postWb("/wb-git/repos", { sessionId }).then((value) => {
					...
					if (value.repos.length === 1) {
						...
						workbench.openView(GRAPH_VIEW_ID, {
							...
							meta: {
								sessionId,
								...repo.depth === 0 ? {} : { repoRoot: repo.root }
							}
						}, { floating: true });
			...
			}, (0, react.createElement)("div", { className: "dg-repo-item-top" }, (0, react.createElement)("span", { className: "dg-repo-name" }, repo.name), typeof repo.branch === "string" && repo.branch !== "" ? (0, react.createElement)("span", {
				className: "dg-repo-branch",
				title: t("repoBranch")
			}, repo.branch) : null, (0, react.createElement)("span", {
			...
			return (0, react.createElement)("div", { className: "dsh-wb-view dg-repo-launcher" }, repos.length > 0 ? (0, react.createElement)("div", { className: "dg-repo-list-hint" }, t("repoListHint")) : null, (0, react.createElement)("div", { className: "dg-repo-list" }, repos.length === 0 ? (0, react.createElement)("div", { className: "dg-repo-empty" }, (0, react.createElement)("div", null, t("noReposFound")), cwd !== null ? (0, react.createElement)("div", {
				className: "dg-muted",
				style: {
					marginTop: 4,
					fontSize: 12
				}
			}, cwd) : null, (0, react.createElement)("button", {
				className: "dg-btn",
				style: { marginTop: 8 },
				onClick: () => setReloadTick((n) => n + 1)
			}, t("retry"))) : rows));
