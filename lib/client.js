		...
		*/
		...
		function GitLauncher(props) {
			...
			*  /wb-git/repos response overwrite a newer one. */
			...
			if (error !== null) return (0, react.createElement)("div", { className: "dsh-wb-view dg-repo-list" }, (0, react.createElement)("div", { className: "dg-repo-list-title" }, t("repoSelectorTitle")), (0, react.createElement)("div", { className: "dg-err" }, `${t("error")}: ${error}`), (0, react.createElement)("button", {
				className: "dg-btn",
				style: { margin: "4px 2px" },
				onClick: () => setReloadTick((n) => n + 1)
			}, t("retry")));
			if (repos === null) return (0, react.createElement)("div", { className: "dsh-wb-view dg-repo-list" }, (0, react.createElement)("div", { className: "dg-repo-list-title" }, t("repoSelectorTitle")), (0, react.createElement)("div", { className: "dg-loading" }, loading ? t("loading") : "…"));
			const rows = repos.map((repo) => (0, react.createElement)("div", {
				...
				className: "dg-repo-depth",
				title: t("openRepo")
			}, depthLabel(repo.depth, t))), (0, react.createElement)("div", {
				className: "dg-repo-path",
				title: repo.root
			}, repo.root)));
			return (0, react.createElement)("div", { className: "dsh-wb-view dg-repo-list" }, (0, react.createElement)("div", { className: "dg-repo-list-title" }, t("repoSelectorTitle")), repos.length > 0 ? (0, react.createElement)("div", { className: "dg-repo-list-hint" }, t("repoListHint")) : null, repos.length === 0 ? (0, react.createElement)("div", { className: "dg-repo-empty" }, (0, react.createElement)("div", null, t("noReposFound")), cwd !== null ? (0, react.createElement)("div", {
				className: "dg-muted",
				style: {
					marginTop: 4,
					fontSize: 12
